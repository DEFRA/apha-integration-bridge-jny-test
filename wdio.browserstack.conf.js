...
export const config = {
  ...
  baseUrl: `https://apha-integration-bridge-jny-test.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `apha-integration-bridge-jny-test-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `apha-integration-bridge-jny-test-${process.env.ENVIRONMENT}`
        },
