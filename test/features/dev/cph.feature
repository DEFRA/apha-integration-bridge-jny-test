...
Feature: (AIL-245) HOLDINGS endpoint tests
  ...
  Scenario Outline: 05 Verify that the appropriate error message is returned when a user supplies an invalid CPH number
    ...
    Examples:
      | endpoint | id            | message                                                                                                                                                                                                                                                                                                                                                            |
      | holdings | 02ww/055/2422 | "countyId" length must be 2 characters long. "countyId" with value "02ww" fails to match the required pattern: /^\\d+$/                                                                                                                                                                                                                                            |
      | holdings |   2w/055/2422 | "countyId" with value "2w" fails to match the required pattern: /^\\d+$/                                                                                                                                                                                                                                                                                           |
      | holdings | 02/055ss/0224 | "parishId" length must be 3 characters long. "parishId" with value "055ss" fails to match the required pattern: /^\\d+$/                                                                                                                                                                                                                                           |
      | holdings |   02/05s/0224 | "parishId" with value "05s" fails to match the required pattern: /^\\d+$/                                                                                                                                                                                                                                                                                          |
      | holdings |   02/055/022w | "holdingId" with value "022w" fails to match the required pattern: /^\\d+$/                                                                                                                                                                                                                                                                                        |
      | holdings |  02/055/022ws | "holdingId" length must be 4 characters long. "holdingId" with value "022ws" fails to match the required pattern: /^\\d+$/                                                                                                                                                                                                                                         |
